...
public class TakenRemindAdapter extends ArrayAdapter<ReminderPlanet> implements Filterable {
    ...
    public TakenRemindAdapter(@NonNull Context context, List<ReminderPlanet> mPlanetlist) {
        super(context, R.layout.reminder_list_taken);
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        View v = View.inflate(mContext, R.layout.reminder_list_taken, null);
        TextView txtname = (TextView) v.findViewById(R.id.tvremindtname);
        TextView txtdate = (TextView) v.findViewById(R.id.tvremindtdate);
        TextView txtamount = (TextView) v.findViewById(R.id.tvremindtamt);
